...
try {
    ...
    foreach ($textQuery as $val){
        ...
        switch ($val['output']) {
            case 'embedUrl420':
                $embedUrl420 = $val['content'];
                break;
            case 'welcometextheader420':
                $welcometextheader420 = $val['content'];
                break;
            case 'welcometext420':
                $welcometext420 = $val['content'];
                break;
            case 'department420':
                $department420 = $val['content'];
                break;
            case 'mng420':
                $mng420 = $val['content'];
                break;
            case 'contact420':
                $contact420 = $val['content'];
                break;
            case 'email420':
                $email420 = $val['content'];
                break;
        }
    }
    ...
    foreach ($imgQuery as $imgOpt){
        ...
        switch  ($imgOpt['output']) {
            case 'welcomeimg420':
                $welcomeimg420 = $imgOpt['filename'];
                break;
            case 'slide1420';
                $slide1420 = $imgOpt['filename'];
                break;
            case 'slide2420';
                $slide2420 = $imgOpt['filename'];
                break;                
        }
...
<body>
    <header>
        ...
        <div class = "Header">
            ...
            <div class ="no"><b>4.2</b>
            
                <div class = "dropdowncont1">
               
                    <div class = "dropdown1">
                        
                        <li><a href="3.1.html">3.1 Admission Services</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.2.html">3.2 Scholarships and Financial Assistance</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.3.html">3.3 Food Services</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                         <li><a href="3.4.html">3.4 Health Services</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                         <li><a href="3.5.html">3.5 Safety and Security Services</a></li>
                         <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.6.html">3.6 Student Housing and Residential</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.7.html">3.7 Foreign/International Students Services</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.8.html">3.8 Services for Specific Students Guidance</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.9.html">3.9 Cultural and Arts Programs</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.10.html">3.10 Sports Development Programs</a></li>
                        <hr color = "#f2f1f1" size = "1px" >
                        <li><a href="3.11.html">3.11 Social and Community Involvement Programs</a></li>
    ...
    <div class="Section1">
        ...
        <div class = "Info">
            <img src="ICON/<?php echo $welcomeimg420 ?>" class = "ILogo">
        
        </div>
        
        <div class = "S1C1">
        
            <p class = "h1"><?php echo $welcometextheader420 ?></p>
            <hr class = "rec1" color ="#006a4e ">
            <p class = "h2"><?php echo $welcometext420 ?></p>
   ...
   <div class = "Section2">
        <div class = "ImgCont">
            <div class="button">
             ...
             <button class="btnright" onclick="plusDivs(1)">&#10095;</button>
                ...
                <img class="mySlides" src="Resources/images/<?php echo $slide1420 ?>" style="width:100%">
                <img class="mySlides" src="Resources/images/<?php echo $slide2420 ?>" style="width:100%">
            </div>
            </div>
        </div>
        <div class = "S2C1">
        <b>
        <li><a href = "#" class = "c11"><?php echo $department420 ?></a></li>
            <li><a href = "#" class = "c12"><?php echo $mng420 ?></a></li>
            <li><a href = "#"  class = "c13">&#128222; &nbsp;<?php echo $contact420 ?></a></li>
            <li><a href = "#" class = "c14">&#9993; &nbsp;<?php echo $email420 ?></a></li>
        </b>
    </div>
    ...
    <div class="events ">
        ...
        src="<?php echo $embedUrl420 ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
    </div>
