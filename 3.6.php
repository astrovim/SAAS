...
<body>
    ...
    <div class="Section1">
        ...
        <div class = "Info">
            <img src="ICON/<?php echo $welcomeimg36 ?>" class = "ILogo">
        
        </div>
        
        <div class = "S1C1">
        
            <p class = "h1"><?php echo $welcometextheader36 ?></p>
            <hr class = "rec1" color ="#006a4e ">
            <p class = "h2"><?php echo $welcometext36 ?></p>
   ...
   <div class = "Section2">
        <div class = "ImgCont">
            <div class="button">
             ...
             <button class="btnright" onclick="plusDivs(1)">&#10095;</button>
                ...
                <img class="mySlides" src="Resources/images/<?php echo $slide136 ?>" style="width:100%">
                <img class="mySlides" src="Resources/images/<?php echo $slide236 ?>" style="width:100%">
            </div>
            </div>
        </div>
        <div class = "S2C1">
        <b>
        <li><a href = "#" class = "c11"><?php echo $department36 ?></a></li>
            <li><a href = "#" class = "c12"><?php echo $mng36 ?></a></li>
            <li><a href = "#"  class = "c13">&#128222; &nbsp;<?php echo $contact36 ?></a></li>
            <li><a href = "#" class = "c14">&#9993; &nbsp;<?php echo $email36 ?></a></li>
        </b>
    </div>
    ...
    <div class="events ">
        ...
        src="<?php echo $embedUrl36 ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>
    </div>
