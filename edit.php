...
<div id='MainEditSection' style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="mainslide" id="mainslide">
            ...
            <form action="editing.php" method="POST">
            <select name="mainslidermv" id="mainslidermv"  <?php if($i==1) echo 'disabled'; ?>>
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($galQuery as $gal){
            ...
            <form action="editing.php" method="POST">
            <select name="service1icon" id="service1icon">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($icodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="service2icon" id="service2icon">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($icodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="service3icon" id="service3icon">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($icodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="1.1EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg11" id="welcomeimg11">
                <option value="default">--Select Image--</option>
                <?php 
            ...
            <form action="editing.php" method="POST">
            <select name="slide111" id="slide111">
                <option value="default">--Select Image--</option>
                <?php 
            ...
            <form action="editing.php" method="POST">
            <select name="slide211" id="slide211">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="1.2EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg12" id="welcomeimg12">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide112" id="slide112">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide212" id="slide212">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="1.3EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg13" id="welcomeimg13">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide113" id="slide113">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide213" id="slide213">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="1.4EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg14" id="welcomeimg14">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide114" id="slide114">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide214" id="slide214">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="1.5EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg15" id="welcomeimg15">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide115" id="slide115">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide215" id="slide215">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="2.1EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg21" id="welcomeimg21">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide121" id="slide121">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide221" id="slide221">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="2.2EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg22" id="welcomeimg22">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide122" id="slide122">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide222" id="slide222">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="2.3EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg23" id="welcomeimg23">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide123" id="slide123">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide223" id="slide223">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="2.4EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg24" id="welcomeimg24">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide124" id="slide124">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide224" id="slide224">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="2.5EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg25" id="welcomeimg25">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide125" id="slide125">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide225" id="slide225">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.1EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg31" id="welcomeimg31">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide131" id="slide131">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide231" id="slide231">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.2EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg32" id="welcomeimg32">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide132" id="slide132">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide232" id="slide232">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.3EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg33" id="welcomeimg33">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide133" id="slide133">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide233" id="slide233">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.4EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg34" id="welcomeimg34">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide134" id="slide134">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide234" id="slide234">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.5EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg35" id="welcomeimg35">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide135" id="slide135">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide235" id="slide235">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.6EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg36" id="welcomeimg36">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide136" id="slide136">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide236" id="slide236">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.7EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg37" id="welcomeimg37">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide137" id="slide137">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide237" id="slide237">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.8EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg38" id="welcomeimg38">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide138" id="slide138">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide238" id="slide238">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.9EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg39" id="welcomeimg39">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide139" id="slide139">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide239" id="slide239">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.10EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg310" id="welcomeimg310">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide1310" id="slide1310">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide2310" id="slide2310">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
...
<div id="3.11EditSection" style="display:none">
            ...
            <form action="editing.php" method="POST">
            <select name="welcomeimg311" id="welcomeimg311">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSubicodir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide1311" id="slide1311">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
            ...
            <form action="editing.php" method="POST">
            <select name="slide2311" id="slide2311">
                <option value="default">--Select Image--</option>
                <?php 
                    foreach($imgSlidedir as $d){
                        echo '<option value="'. $d .'">' . $d . '</option>';
